...
class Database:
    ...
    def new_user(self, id):
        return dict(
            ...
            suffix=None,
            metadata=False,
            metadata_code=""" Kdramaland" -metadata" -metadata:s:s title="-map 0 -c:s copy -c:a copy -c:v copy -metadata title="Powered By:- @Shahil440" -metadata author="@Shahil440" -metadata:s:s title="Subtitled By :- @Shahil440" -metadata:s:a title=" @Shahil440" -metadata:s:v title=" @Shahil440" """
        )
